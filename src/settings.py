...
##################################
PROJECT_NAME: str = "PCB Defect"
PROJECT_NAME_FULL: str = "PCB Defect"
...
APPLICATIONS: List[Union[Industry, Domain, Research]] = [Industry.Manufacturing(), Domain.DamageDetection()]
CATEGORY: Category = Category.Manufacturing()

CV_TASKS: List[CVTask] = [CVTask.ObjectDetection()]
ANNOTATION_TYPES: List[AnnotationType] = [AnnotationType.ObjectDetection()]

RELEASE_DATE: Optional[str] = "2019-02-22"  # e.g. "YYYY-MM-DD"
...
PREVIEW_IMAGE_ID: int = 8505043
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/pcb-defect"
# URL to GitHub repo on dataset ninja (e.g. "https://github.com/dataset-ninja/some-dataset")

##################################
### * Optional after uploading ###
##################################
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = "https://www.dropbox.com/s/32kolsaa45z2mpj/PCB_DATASET.zip?dl=0"
